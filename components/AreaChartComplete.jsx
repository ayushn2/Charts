...
const AreaChartComplete = () => {
  return (
    <div className="flex flex-col items-center justify-center p-4 border border-slate-900 bg-slate-900/50 rounded-xl h-[400px] w-[500px]">
...
export default AreaChartComplete;
